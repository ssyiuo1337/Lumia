...
const messages = {
  'en-US': {
    ...
    faq: {
      ...
      q1: 'How to launch Lumia Software after Purchase?',
      a1: 'After purchasing a subscription, download the installer from your profile and run it. The program will be installed on your computer, and "Lumia" will appear in your applications list. Use it to launch our software.',
      ...
      a3: 'Your profile information is updated automatically. You do not need to do anything. We advise you not to forcefully turn off Lumia (alt + f4) as information about the session may not be saved.',
